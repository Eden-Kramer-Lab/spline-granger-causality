...
splinetime  = toc;
[ bhat, yhat,yhat_glmfit] = estimate_coefficient_fits( model_true, adj_spline);
...
model_spline.signal_estimate_glm = yhat_glmfit;

%%% Fit standard-Granger model to data ------------------------------------
tic
[ adj_standard] = build_ar( model_true );
standardtime  = toc;
[ bhat, yhat,yhat_glmfit] = estimate_standard( model_true, adj_standard);
...
model_standard.signal_estimate_glm = yhat_glmfit;
